...
I am a PhD student in Computer Science. These are my technical skills:
Programming & OS: Python (Asyncio), C/C++ (Qt), Java, Lua, Bash/Shell, SQL, Linux
- Machine Learning & AI: PyTorch, Scikit-learn, Hugging Face, spaCy, NLTK, SciBERT, LangChain, FAISS, RAG, Generative AI, Fine-Tuning, Spark MLlib, Word2Vec, NumPy, Pandas, SciPy, Matplotlib
- Architectures & Domains: Contrastive Learning, Triplet Margin Loss, Transformers, RNNs, Encoders, ASR, NLU, Acoustic & Language Modeling
- MLOps, Cloud & Backend: Docker, FastAPI, SQLAlchemy, Pydantic, Apache Airflow, TorchServe, Inference Optimization, Celery, Redis, RabbitMQ, MinIO, WebSockets, Pytest, FFmpeg, Casbin, HAProxy, OpenAPI, AWS
- Data Engineering & Big Data: Hadoop, Spark, Hive, HBase, Cassandra, MongoDB, MySQL, SQLite, GraphX, HDFS, YARN, MapReduce, PostgreSQL
- DevOps, Monitoring & Agile: Prometheus, Grafana, SonarQube, Ansible, Bitbucket, Gitea, Drone, Jira, Confluence, Git, DVC, MLflow
